...
var file_front_service_v1_i_authentication_proto_rawDesc = []byte{
	...
	0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x66, 0x72, 0x6f, 0x6e,
...
func file_front_service_v1_i_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_front_service_v1_i_authentication_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_front_service_v1_i_authentication_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_front_service_v1_i_authentication_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_front_service_v1_i_authentication_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_front_service_v1_i_authentication_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
