...
func (c *systemServiceClient) ListSystem(ctx context.Context, in *pagination.PagingRequest, opts ...grpc.CallOption) (*ListSystemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.v1.SystemService/ListSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemServiceClient) GetSystem(ctx context.Context, in *GetSystemRequest, opts ...grpc.CallOption) (*System, error) {
	out := new(System)
	err := c.cc.Invoke(ctx, "/blog.v1.SystemService/GetSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemServiceClient) CreateSystem(ctx context.Context, in *CreateSystemRequest, opts ...grpc.CallOption) (*System, error) {
	out := new(System)
	err := c.cc.Invoke(ctx, "/blog.v1.SystemService/CreateSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemServiceClient) UpdateSystem(ctx context.Context, in *UpdateSystemRequest, opts ...grpc.CallOption) (*System, error) {
	out := new(System)
	err := c.cc.Invoke(ctx, "/blog.v1.SystemService/UpdateSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemServiceClient) DeleteSystem(ctx context.Context, in *DeleteSystemRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.v1.SystemService/DeleteSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SystemService_ListSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.v1.SystemService/ListSystem",
	}
...
func _SystemService_GetSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.v1.SystemService/GetSystem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SystemService_CreateSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.v1.SystemService/CreateSystem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SystemService_UpdateSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.v1.SystemService/UpdateSystem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SystemService_DeleteSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.v1.SystemService/DeleteSystem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SystemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "blog.v1.SystemService",
