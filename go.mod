...
require (
	github.com/go-kratos/kratos/contrib/config/consul/v2 v2.0.0-20220924152900-2170a12aa477
	github.com/go-kratos/kratos/contrib/config/etcd/v2 v2.0.0-20220920032430-080165f2ee46
	github.com/go-kratos/kratos/contrib/config/nacos/v2 v2.0.0-20220921072156-7866ff75fd6c
