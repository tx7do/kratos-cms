...
func (*Post) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case post.FieldID, post.FieldCreateTime, post.FieldUpdateTime, post.FieldCommentCount, post.FieldVisits, post.FieldLikes, post.FieldWordCount, post.FieldTopPriority, post.FieldStatus, post.FieldEditorType, post.FieldEditTime:
