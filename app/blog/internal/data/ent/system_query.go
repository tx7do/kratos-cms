...
func (sq *SystemQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *SystemQuery) FirstIDX(ctx context.Context) uint64 {
...
func (sq *SystemQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *SystemQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (sq *SystemQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (sq *SystemQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SystemQuery) GroupBy(field string, fields ...string) *SystemGroupBy {
	grbuild := &SystemGroupBy{config: sq.config}
...
func (sq *SystemQuery) Select(fields ...string) *SystemSelect {
	...
	selbuild := &SystemSelect{SystemQuery: sq}
	selbuild.label = system.Label
