...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:qT66gldDXAzZNbgu3E/LwTROWrZejG6n8tVMRuyw/vA=",
        version = "v0.51.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:SY3RtN89D0f66E5Tz+2etAej6CodvfWHiydz8SezGJM=",
        version = "v2.0.0-20221130041748-2cf82fa4a75c",
    )
    go_repository(
        name = "com_github_go_kratos_kratos_contrib_config_etcd_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/go-kratos/kratos/contrib/config/etcd/v2",
        sum = "h1:aYx3GqeF5O7VrYNBbtkUQBXCfcWeaMRaul/ki5FDJgA=",
        version = "v2.0.0-20221130041748-2cf82fa4a75c",
    )
    go_repository(
        ...
        sum = "h1:xFOS7XKVXAcQotLWRCki9pDMCr9Pw4QQfRG7ef+fuik=",
        version = "v2.0.0-20221130041748-2cf82fa4a75c",
    )
    go_repository(
        ...
        sum = "h1:dYnT4etJUJebwXHeEEMd13+phOrk/hNzJFyko5/Isnw=",
        version = "v2.0.0-20221130041748-2cf82fa4a75c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:aqytbw31uCPNn37ST+717IyGod+P1eTgSGu3yjRo4bs=",
        version = "v1.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:sV7YKTFYqnFi5ar1fPPX6MRj7Mtmy81LaUQLFkNrWto=",
        version = "v0.0.6",
    )
    go_repository(
        name = "com_github_tx7do_kratos_authn_authn",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/tx7do/kratos-authn/authn",
        sum = "h1:8RALbSMXZMQiem58q8DFO0UOp0ycgV2kEvV1Ygpi4i8=",
        version = "v0.0.0-20221130123508-fed84d7952e9",
    )
    go_repository(
        name = "com_github_tx7do_kratos_authn_engine_jwt",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/tx7do/kratos-authn/engine/jwt",
        sum = "h1:9Z/HYXCMVClLDG25Qi9rSaELfTsEXKX4/qClez+/4SI=",
        version = "v0.0.0-20221220153430-9d1496472c00",
    )
    go_repository(
        name = "com_github_tx7do_kratos_authn_middleware",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/tx7do/kratos-authn/middleware",
        sum = "h1:ijG1aLVMwhkAufor9XcIlF35DGlzJedfGlFE4Eo2Dk8=",
        version = "v0.0.0-20221220161625-08fd42ab33cc",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:SZvfq/z4FWeQLYxYyAcgj5vuClQWyu7yNpBonkRTfg0=",
        version = "v0.0.0-20221220153124-4ba033f69ed6",
    )
    go_repository(
        name = "com_github_tx7do_kratos_authz_engine_opa",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/tx7do/kratos-authz/engine/opa",
        sum = "h1:nRll0Ce9SV/K5o7zqTpwH0VSC/uuQ7/id8JigUMhbG0=",
        version = "v0.0.0-20221220153124-4ba033f69ed6",
    )
    go_repository(
        ...
        sum = "h1:MuiYe2EhJuPV1/RUHs5iuiljLXCy/VVStMqqPe1tGFk=",
    ...
    go_repository(
        ...
        sum = "h1:qV1wlqehwEYkmkB2AArRghrQnruQmw8DqweeJYNre6I=",
        version = "v0.11.6",
    )
    go_repository(
